...
** Commands
| regex-collection-get             | prompt the user for a predefined regexp                                                   |
| regex-collection-search-forward  | prompt the user for a predefined regexp, and search forward for it in the current buffer  |
| regex-collection-search-backward | prompt the user for a predefined regexp, and search backward for it in the current buffer |
